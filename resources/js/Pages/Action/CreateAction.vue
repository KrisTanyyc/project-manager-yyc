  ...
  <div class="flex flex-row h-full w-full">
    ...
    <div class="flex flex-col flex-auto bg-white w-4/5 h-screen">
      ...
      <div class="flex flex-col flex-auto h-4/5 w-full bg-white">
        ...
        >
          <div class="mt-5 ml-5">
            <span class="font-bold text-3xl">Create Action</span>
          </div>
          <div class="m-3 mt-10">
          ...
          <div class="pt-5 mr-10 flex flex-row justify-end">
            ...
            <a
              :href="
                '/project/' + project_id + '/module/' + module_id + '/actions'
              "
...
export default defineComponent({
  ...
  methods: {
    checkValidation() {
      ...
      if (!this.action.name) {
        this.errors["name"] = "Please enter the action name";
      }
    },

    createAction() {
      this.errors = [];
      var url = "/api/module/" + this.module_id + "/action/create",
        method = "post";
      fetch(url, {
        method: method,
        body: JSON.stringify({
