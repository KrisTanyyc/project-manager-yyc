  ...
  <div class="flex flex-row h-full w-full">
    ...
    <div class="flex flex-col flex-auto bg-white w-4/5 h-screen">
      ...
      <div class="flex flex-col flex-auto h-4/5 w-full bg-white">
        ...
        >
          <div class="mt-5 ml-5">
            <span class="font-bold text-3xl">Update Module</span>
          </div>
          <div class="m-3 mt-10">
          ...
          <div class="flex justify-center" v-if="'module' in errors">
            <label class="text-red-500">{{ errors["module"] }}</label>
          </div>
          ...
          <div class="pt-5 mr-10 flex flex-row justify-end">
            ...
            <a
              :href="'/projects/' + data.project_id +'?tab=2'"
...
export default defineComponent({
  ...
  methods: {
    checkValidation() {
      this.errors = [];
      if (this.smodule.name !== "" && this.smodule.name !== null) {
        this.updateModule();
        this.isButtonClicked = true;
      }
      if (!this.smodule.name) {
        this.errors["module"] = "Please enter the module name";
      }
    },
    ...
    updateModule() {
      ...
      fetch(url, {
        ...
        .then((response) => {
          if (response.success) {
            window.location.href = "/projects/" + this.data.project_id +"?tab=2";
          }
        })
